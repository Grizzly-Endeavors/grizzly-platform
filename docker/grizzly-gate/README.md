...
- **Build:** `kubernetes/infrastructure/argo-workflows/build-gate-image.yaml` clones the grizzly-gate repo and builds it in-cluster via rootless BuildKit. The trigger workflow now lives in that repo (`.github/workflows/build-gate-image.yaml`).
